    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Cidade
                    <small>Listar</small>
                    <a href="{{ route('city.create') }}" class="btn btn-info" title="Adicionar novo registro">
        ...
        <div class="col-12">
            <table id="grid-data" class="table table-condensed table-hover table-striped">
                ...
                <tr>
                    ...
                    <th data-column-id="state" data-sortable="true">Estado</th>
