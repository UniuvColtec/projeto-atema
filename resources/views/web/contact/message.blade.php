...
<p><strong>Descrição do evento:</strong>{{$data['description']}}</p>
<p><strong>Cidade:</strong>{{$data['city']}}</p>
<p><strong>Data de inicio:</strong>{{$data['start_date']}}</p>
<p><strong>Data de termino:</strong>{{$data['final_date']}}</p>
