                ...
                @foreach( $tourist_spots as $tourist_spot)
                    <a class="my-3 m-md-0 " href="{{ route('web.touristspot.show', $tourist_spot->id) }}">
                        <div class="card h-100 ">
                            <img class="card-img-top"  src="{{ asset('files/' . $tourist_spot->firstImage->image->address) }}" alt="{{ $tourist_spot->name }}">
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <div class="mt-2">
                                    <p>
                                        ...
                                        {{ $tourist_spot->city->name . ' - ' . $tourist_spot->city->state }}
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container py-5">
            <div class="row row-cols-1 row-cols-lg-2">
                ...
                <form class="d-flex my-3 my-md-4 my-lg-5" role="search">
                    <input class="form-control rounded-5 bg-gray" type="search" placeholder="deixe seu e-mail aqui" aria-label="Search">
                </form>
            </div>
        </div>
    </div>
