                ...
                <div class="info-flex">
                    ...
                    <div class="col-12 col-md-6 d-flex flex-column flex-lg-row justify-content-between gap-2 gap-md-0 mt-3 mt-lg-0">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <span class="badge rounded-pill text" style="background-color: #0a8f72" >{{ $partner->city->name .' - '.$partner->city->state}}</span>
                        </div>
                    </div>
                    <div class="types-display">
                        <div class="type-itens">
                            <span class="badge rounded-pill text" style="background-color: #0a8f72" >{{$partner->partner_type->name}}</span>
                        </div>
                    </div>
                    <div class="col-12 col-xl-6 py-2 mt-3 mt-lg-0">
                        <div class="d-flex justify-content-between col-7 gap-4">
                            <div class="d-flex align-items-center gap-1 text-nowrap">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0a8f72"
