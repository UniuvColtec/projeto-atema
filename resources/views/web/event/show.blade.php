        ...
        <div class="row">
            ...
            <div class="row my-5">
                <div class="col-12 col-xl-6">
                    <div id="imagemevento" class="carousel slide w-100 sliderevento" data-bs-ride="true">
                    ...
                    <div class="accordion accordion-flush" id="turismo-local-loop-container">
                        <div class="accordion-item">
                            @foreach($tourist_spots as $tourist_spot)
                                @if($tourist_spot->city_id == $event->city->id)
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#turismo-local-loop-item-{{ $tourist_spot->id }}" aria-expanded="false"
                                        aria-controls="turismo-local-loop-item-{{ $tourist_spot->id }}">
                                    {{ $tourist_spot->name }}
                                </button>
                            </h2>
                            <div id="turismo-local-loop-item-{{ $tourist_spot->id }}" class="accordion-collapse collapse"
                                 aria-labelledby="panelsStayOpen-headingOne">
                                <div class="accordion-body">
                                    <img src="{{ asset('files/' . $tourist_spot->firstImage->image->address) }}" class="img-fluid" alt="">
                                    <div class="mt-2"> {!!$tourist_spot->description!!}</div>
